...
class ViconTransfer:
    def __init__(self):
        ...
        self.vicon_pose_sub = rospy.Subscriber("/vrpn_client_node/snowyowl/pose", PoseStamped, self.vicon_pose_callback)
        self.vicon_twist_sub = rospy.Subscriber("/vrpn_client_node/snowyowl/twist", TwistStamped, self.vicon_twist_callback)

        self.odom_pub = rospy.Publisher("/snowyowl/autopilot/state_estimate", Odometry, queue_size=5)
    ...
    def clue(self):
        ...
        self.odom.child_frame_id = "snowyowl/base_link"
